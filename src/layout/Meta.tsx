    ...
    <>
      <Head>
        ...
        <link
          rel="preload"
          as="image"
          href={`${router.basePath}/assets/images/projects/chile.png`}
        />
        <link
          rel="preload"
          as="image"
          href={`${router.basePath}/assets/images/projects/basketball.png`}
        />
        <link
          rel="preload"
          as="image"
          href={`${router.basePath}/assets/images/projects/soccer.png`}
        />
