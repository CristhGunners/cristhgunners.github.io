...
const Main = (props: IMainProps) => {
  return (
    <div className="w-full px-4 text-neutral-400 antialiased">
      {props.meta}
      ...
      <div className="relative z-30 mx-auto max-w-screen-md">
          ...
          <nav className="flex items-center justify-center space-x-6">
            ...
            >
              <svg
                ...
                className="h-6 w-6 fill-black hover:fill-cyan-600 dark:fill-neutral-400 dark:hover:fill-cyan-600"
              >
		...
		c4.598,5.108,7.961,12.372,8.881,22.198h-62.697C298.697,249.669,299.287,246.572,300.278,243.159z"
          ...
          <div className="mt-8 text-center text-sm text-gray-700 dark:text-neutral-400">
            © Copyright {new Date().getFullYear()}{' '}
            <Link href={'/about'} passHref>
              <span className="cursor-pointer hover:text-cyan-600 dark:hover:text-cyan-600">
                {AppConfig.title}
              </span>
            </Link>
          </div>
